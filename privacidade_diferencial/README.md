...
$$\frac{\frac{1}{2b}e^{-\frac{|y-f(D)|}{b}}}{\frac{1}{2b}e^{-\frac{|y-f(D')|}{b}}} = e^{\frac{-|y-f(D)| + |y-f(D')|}{b}}$$
...
$$\frac{p_D(y)}{p_{D'}(y)} \le e^{\frac{|f(D)-f(D')|}{b}}$$
...
$$\frac{p_D(y)}{p_{D'}(y)} \le e^{\frac{\Delta f}{b}} = e^{\frac{\Delta f}{\Delta f/\varepsilon}} = e^\varepsilon$$
